...
def get_duration(raw_duration: str) -> timedelta:
    ...
    _dispatcher = {
        'w': lambda total_duration, duration: total_duration + timedelta(weeks=duration),
        'd': lambda total_duration, duration: total_duration + timedelta(days=duration),
        'h': lambda total_duration, duration: total_duration + timedelta(hours=duration),
        'm': lambda total_duration, duration: total_duration + timedelta(minutes=duration),
        's': lambda total_duration, duration: total_duration + timedelta(seconds=duration),
    }
