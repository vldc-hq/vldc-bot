...
def _remove_Message_after_timer(message: Message, context: CallbackContext, seconds: int):
        ...
        def cleanup_wrapper(*args, **kwargs):
            for arg in args:
                if isinstance(arg, CallbackContext):
                    _hook_function(arg.bot, '_message', lambda *args, **kwargs: 1, lambda msg, *args, **kwargs: ( _remove_Message_after_timer(msg, arg, seconds) ) )
